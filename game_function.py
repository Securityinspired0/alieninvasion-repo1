...
def update_bullet(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Update the position of bullet and get rid of the old ones"""
    #Update bullet position
    bullets.update()   
        
     #Get rid of bullets tha that have disappeared
...
def check_bullet_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    #Remove any bullet and alien that has collided 
...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_buttons(ai_settings, screen, stats, sb, play_button, ship,
                aliens, bullets, mouse_x, mouse_y)

def check_play_buttons(ai_settings, screen, stats, sb, play_button, ship, aliens,
...
def get_number_row(ai_settings, ship_height, alien_height):
    """Determine the number of rows of alien that fits the screen"""
    availale_space_y = (ai_settings.screen_height -
                        (3 * alien_height) - ship_height)
    number_rows = int(availale_space_y / (3 * alien_height))
    return number_rows
...
def create_fleet(ai_settings, screen, ship, aliens):
    """Create a fleet full of Alien"""
    #Create an alient and find the number of alien in a row.    
    alien = Alien(ai_settings, screen)
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    #Redraw all bullet behind ship and aline
